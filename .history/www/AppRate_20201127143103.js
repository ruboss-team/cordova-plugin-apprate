...
var AppRate = (function () {
  ...
  var PREF_STORE_URL_FORMAT_IOS8 =
    "http://itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?pageNumber=0&sortOrdering=1&type=Purple+Software&mt=8&id=";
      ...
      case 1:
        ...
        if (typeof base.handleNegativeFeedback === "function") {
          navigator.notification.confirm(
            localeObj.feedbackPromptMessage,
            promptForFeedbackWindowButtonClickHandler,
            localeObj.feedbackPromptTitle,
            [localeObj.noButtonLabel, localeObj.yesButtonLabel]
          );
        }
        break;
      case 2:
        ...
        navigator.notification.confirm(
          ...
          localeObj.title,
          [localeObj.cancelButtonLabel, localeObj.laterButtonLabel, localeObj.rateButtonLabel]
        );
        break;
    }
    return typeof base.onButtonClicked === "function"
      ? base.onButtonClicked(buttonIndex, currentBtn, "AppRatingPrompt")
      : function () {};
  }
  ...
  function promptForStoreRatingWindowButtonClickHandler(buttonIndex) {
    ...
    typeof base.onButtonClicked === "function"
      ? base.onButtonClicked(buttonIndex, currentBtn, "StoreRatingPrompt")
      : function () {};
  ...
  function promptForFeedbackWindowButtonClickHandler(buttonIndex) {
    ...
    return typeof base.onButtonClicked === "function"
      ? base.onButtonClicked(buttonIndex, currentBtn, "FeedbackPrompt")
      : function () {};
  }
  ...
  function showDialog(immediately) {
    ...
    if (counter.countdown === preferences.usesUntilPrompt || immediately) {
      ...
      if (
        !preferences.showPromptForInAppReview &&
        isNativePromptAvailable &&
        preferences.reviewType &&
        ((IS_IOS && preferences.reviewType.ios === "InAppReview") ||
          (IS_ANDROID && preferences.reviewType.android === "InAppReview"))
      ) {
        updateCounter("stop");
        AppRate.navigateToAppStore();
        ...
        navigator.notification.confirm(
          localeObj.appRatePromptMessage,
          promptForAppRatingWindowButtonClickHandler,
          localeObj.appRatePromptTitle,
          [localeObj.noButtonLabel, localeObj.yesButtonLabel]
        );
      }
  ...
  AppRate.init = function () {
    ...
    var storagePromise = Storage.get(LOCAL_STORAGE_COUNTER)
      ...
      .catch(noop);
    var initPromise = Promise.all([checkIsNativePromptAvailablePromise, appTitlePromise, storagePromise]);
    if (AppRate.initialized) {
      AppRate.ready = initPromise;
    } else {
      AppRate.initialized = true;
      initPromise.then(AppRate.readyResolve).catch(AppRate.readyReject);
    }
  };
